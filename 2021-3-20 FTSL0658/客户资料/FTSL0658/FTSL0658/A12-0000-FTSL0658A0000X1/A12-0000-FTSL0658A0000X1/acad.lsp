...
(DEFUN C:A4()
	 ...
	 (command "dimscale" e1)
	 (COMMAND "INSERT" 
		  "K:\\U10984\\▆\\础ン\\009.DWG" pause e1 e1 "0"))
(DEFUN C:A3()
	 (setvar "cmdecho" 0)
	 (setq e1 (getstring "\n Input the scale:"))
	 (setq E2 (GETPOINT "\n Input insert point:"))
	 (COMMAND "INSERT" 
		   "K:\\U10984\\▆\\础ン\\008.DWG" E2 e1 e1 "0"))
(DEFUN C:BOM()
	 (setvar "cmdecho" 0)
	 (setq pt (getpoint "\n input insert point:"))
	 (command "insert" "k:\\u10984\\▆\\础ン\\010.dwg" 1 1 1 0))
;-------------DIM MODIFIED--------------
(defun c:y()
	    (setvar "cmdecho" 0)
...
(DEFUN C:1()
	 ...
	 (COMMAND "INSERT"
		  "K:\\U10984\\▆\\础ン\\003.DWG" PAUSE dsc dsc 0))
(DEFUN C:2()
	 (setq dsc (getvar "dimscale")) 
	 (COMMAND "INSERT"
		  "K:\\U10984\\▆\\础ン\\006.DWG" PAUSE dsc dsc 0))
(DEFUN C:3()
	 (setq dsc (getvar "dimscale")) 
	 (COMMAND "INSERT"
		  "K:\\U10984\\▆\\础ン\\002.DWG" PAUSE dsc dsc 0))
(DEFUN C:4()
	 (setq dsc (getvar "dimscale"))
	 (COMMAND "INSERT"
		  "K:\\U10984\\▆\\础ン\\001.DWG" PAUSE dsc dsc 0))
(DEFUN C:5()
	 (setq dsc (getvar "dimscale"))
	 (COMMAND "INSERT" 
		  "K:\\U10984\\▆\\础ン\\004.DWG" PAUSE dsc dsc 0))
(DEFUN C:6()
	 (setq dsc (getvar "dimscale")) 
	 (COMMAND "INSERT"
		  "K:\\U10984\\▆\\础ン\\005.DWG" PAUSE dsc dsc 0))
(DEFUN C:7()
	 (setq dsc (getvar "dimscale")) 
	 (COMMAND "INSERT"
		  "K:\\U10984\\▆\\础ン\\007.DWG" PAUSE dsc dsc 0))
